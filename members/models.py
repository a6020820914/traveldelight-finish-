...
class Tour(models.Model):
    ...
    tourname = models.CharField(max_length=150, null=True) #旅遊標題名稱
    ...
    tourlink = models.CharField(max_length=150, null=True) # 旅遊行程連結
    gosite = models.ManyToManyField(Site, through="TourSite", through_fields=('tour', 'site'), related_name='tours_as_gosite')# 出發城市
    tourimage = models.CharField(max_length=150, null=True) # 旅遊行程圖片
    ...
    earlierGoDate = models.CharField(max_length=500, null=True)     # 最早可出發日期
    ...
    tourSpecial = models.CharField(max_length=500, null=True) #旅遊行程特色描述
    ...
    travelPoint = models.CharField(max_length=50, null=True) #旅遊景點
    breakfast = models.CharField(max_length=50, null=True) #早餐
    lunch = models.CharField(max_length=50, null=True) #午餐
    dinner = models.CharField(max_length=50, null=True) #晚餐
    hotel = models.CharField(max_length=50, null=True) #住宿
